...
if selected == "Disease Prediction":
    ...
    symptoms = st.multiselect(
        "What are your symptoms?", options=disease_model.all_symptoms
    )
...
if selected == "Heart disease Prediction":
    ...
    with col3:
        ...
        options = list(range(len(display)))
        value = st.selectbox(
            "Chest_Pain Type", options, format_func=lambda x: display[x]
        )
    ...
    with col3:
        ...
        options = list(range(len(display)))
        value = st.selectbox(
            "Peak exercise ST segment", options, format_func=lambda x: display[x]
        )
        if value == "upsloping":
            slope = 0
        elif value == "flat":
...
lung_cancer_data["GENDER"] = lung_cancer_data["GENDER"].map(
    {"M": "Male", "F": "Female"}
)
...
if selected == "Lung Cancer Prediction":
    ...
    if st.button("Predict Lung Cancer"):
        ...
        user_data[numeric_columns] = user_data[numeric_columns].apply(
...
if selected == "Liver prediction":  # pagetitle
    ...
    with col3:
        Alamine_Aminotransferase = st.number_input(
            "Entre your Alamine_Aminotransferase"
        )  # 6
    with col1:
        Aspartate_Aminotransferase = st.number_input(
            "Entre your Aspartate_Aminotransferase"
        )  # 7
    with col2:
    ...
    with col1:
        Albumin_and_Globulin_Ratio = st.number_input(
            "Entre your Albumin_and_Globulin_Ratio"
        )  # 10
    # code for prediction
    liver_dig = ""
...
if selected == "Hepatitis prediction":
    ...
    with col3:
        alamine_aminotransferase = st.number_input(
            "Enter your Alamine Aminotransferase"
        )  # 6

    with col1:
        aspartate_aminotransferase = st.number_input(
            "Enter your Aspartate Aminotransferase"
        )  # 7
    with col2:
    ...
    with col1:
        albumin_and_globulin_ratio = st.number_input(
            "Enter your Albumin and Globulin Ratio"
        )  # 10
        ...
        user_data = pd.DataFrame(
            {
                ...
                "GGT": [
                    your_ggt_value
                ],  # Replace 'your_ggt_value' with the actual value
                "PROT": [
                    your_prot_value
                ],  # Replace 'your_prot_value' with the actual value
            }
        )
...
if selected == "Jaundice prediction":  # pagetitle
    ...
    # t.image(image, caption="Jaundice disease prediction")
    # columns
    # no inputs from the user
    # st.write(info.astype(int).info())
    name = st.text_input("Name:")
    ...
    if st.button("Jaundice test result"):
        jaundice_prediction = [[]]
        jaundice_prediction = jaundice_model.predict(
            [
                [
                    age,
                    Sex,
        ...
        if jaundice_prediction[0] == 1:
            ...
            st.image(image, caption="")
            jaundice_dig = (
                "we are really sorry to say but it seems like you have Jaundice."
            )
        else:
            image = Image.open("negative.jpg")
            st.image(image, caption="")
...
if selected == "Chronic Kidney prediction":
    ...
    with col3:
        sg = st.slider(
            "Enter your Specific Gravity", 1.0, 1.05, 1.02
        )  # Add your own ranges
    ...
    with col1:
        bgr = st.slider(
            "Enter your Blood Glucose Random", 50, 200, 120
        )  # Add your own ranges
    with col2:
    ...
    with col1:
        pcv = st.slider(
            "Enter your Packed Cell Volume", 20, 60, 40
        )  # Add your own ranges
    with col2:
        wc = st.slider(
            "Enter your White Blood Cell Count", 2000, 20000, 10000
        )  # Add your own ranges
    with col3:
        rc = st.slider(
            "Enter your Red Blood Cell Count", 2, 8, 4
        )  # Add your own ranges
...
if selected == "Breast Cancer Prediction":
    ...
    with col1:
        fractal_dimension_mean = st.slider(
            "Enter your Fractal Dimension Mean", 0.01, 0.1, 0.05
        )
    ...
    with col1:
        ...
        fractal_dimension_se = st.slider(
            "Enter your Fractal Dimension SE", 0.01, 0.1, 0.05
        )
    ...
    if st.button("Predict Breast Cancer"):
        ...
        if breast_cancer_prediction[0] == 1:
            ...
            st.image(image, caption="")
            breast_cancer_result = (
                "The model predicts that you don't have Breast Cancer."
            )
